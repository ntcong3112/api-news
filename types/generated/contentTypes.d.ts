...
export interface ApiDanhMucDanhMuc extends Schema.CollectionType {
  collectionName: 'danh_mucs';
  info: {
...
export interface ApiShoppingShopping extends Schema.CollectionType {
  collectionName: 'shoppings';
  info: {
    singularName: 'shopping';
    pluralName: 'shoppings';
    displayName: 'S\u1EA3n ph\u1EA9m li\u00EAn k\u1EBFt';
    description: '';
  };
  options: {
    draftAndPublish: true;
